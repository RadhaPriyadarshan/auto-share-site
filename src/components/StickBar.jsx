...
export default function StickyBar1() {
  return (
    <section className="border-b border-stroke  px-6 py-3 bg-neon-200">
      <div className="container">
        <div className="relative pr-6 text-center text-white">
          <span className="inline-flex h-6 items-center justify-center rounded bg-primary/10 px-2.5 text-sm font-medium text-primary">
            New
          </span>
          <a
            href="#"
            className="inline-flex items-center gap-2 text-sm font-medium text-primary text-white hover:underline underline-offset-4"
          >
            AutoShare goes public on Nasdaq, now trading under the ticker symbol AS. Know more.
            <span>
              <svg
                width="20"
                height="20"
